...
const allData: ProjectsConfig[] = [
    ...
    },
    {
        ...
        "description": {
            ...
            "p2": "Looking back, I realize that this page reflects my evolution as a developer. Although I am a little embarrassed to see all the bad practices I used to use in the past, it is exciting to see how I have improved and grown as a programmer. Keeping this project reminds me that it is important not to be afraid to experiment and try new things, even if that means making mistakes.",
            "p3": 'Despite its imperfections, I feel a great affection for "My Website". I love seeing how it has changed over time and how it has transformed into something better. This project represents my love for programming and my passion for learning. I hope that visitors to the page enjoy its design and content, and that it inspires them to continue experimenting and evolving as developers.'
        },
        "image": {
    ...
    },
    {
        ...
        "title": "GET IT DONE",
        "description": {
            "p1": 'The "GET IT DONE" project is a personal task control tool that allows users to evaluate their effectiveness over different time scales. Its aim is to help users improve their personal productivity and performance. The project incorporates artificial intelligence models to evaluate task results and suggest relevant content to help users improve their weaknesses.',
            "p2": "The project has been developed using modern technologies such as HTML, CSS, SASS, JAVASCRIPT, REACT, NEXTJS, FIGMA, NEXT AUTH, NEXT REDUX, SWEETALERT2, NEXT-ROUTER, among others. The platform is intuitive and easy to use, allowing users to create, organize, and track their tasks effectively. The project also features a user-friendly and attractive interface, making it visually appealing and easy to navigate.",
            "p3": 'In summary, "GET IT DONE" is a comprehensive personal task control platform that utilizes advanced technologies to improve user effectiveness over different time scales. The combination of artificial intelligence models, friendly design, and modern technologies make this tool an excellent option for anyone looking to improve their personal productivity and performance. Additionally, the project source code is available on GitHub for other developers to study and contribute to its continuous improvement.'
        },"image": {
